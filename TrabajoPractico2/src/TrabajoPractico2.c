...
int main(void) {
	...
	do
	{
		...
		switch(opcionMenu)
		{
			...
			break;
			case 3:
				listarJugadores(jugadores,confederaciones,TAM, contadorJugadores,2);
			break;
			case 4:
				//METER SUB MENU
...
/*int modificarJugador(eJugador jugadores, int tam)
{
	int retorno=-1;
	int opcion;
	...
	//VERIFICAR QUE EXISTA AL MENOS 1 JUGADOR CARGADO.
